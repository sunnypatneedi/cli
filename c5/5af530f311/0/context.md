...
**Commit Message:** Can we make it a bit wider
...
Done! I've increased the Branch column from 20 to 30 characters wide. Now it can show longer branch names like:

```
Branch                          Description
──────────────────────────────  ────────────────────────────────────────
main (was feature/add-license)  Add MIT license
soph/improve-session-list       Could we show the commit message...
```

Branch names longer than 30 chars will still be truncated to 27 chars + "..." to keep the table readable.
